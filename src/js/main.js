	...
	function resizeScrenn() {
		if ($(window).width() >= 1020) {
			...
			$('#item1_1_1').mouseenter(function () {
				...
				$('#item1_1_4').css('bacground', 'none')
				$('#item1_1_5').css('bacground', 'none')
				$('#item1_1_6').css('bacground', 'none')
				$('#item1_1_7').css('bacground', 'none')
			})
			$('#item1_1_2').mouseenter(function () {
				$('#list1_1').removeClass('nav-list_active');
				$('#item1_1_1').css('bacground', 'none')
				$('#item1_1_2').css('bacground', '#00B5EE')
				$('#item1_1_3').css('bacground', 'none')
				$('#item1_1_4').css('bacground', 'none')
				$('#item1_1_5').css('bacground', 'none')
				$('#item1_1_6').css('bacground', 'none')
			...
			$('#item1_1_3').mouseenter(function () {
				...
				$('#item1_1_1').css('bacground', 'none')
				$('#item1_1_2').css('bacground', 'none')
				$('#item1_1_3').css('bacground', '#00B5EE')
				$('#item1_1_4').css('bacground', 'none')
				$('#item1_1_5').css('bacground', 'none')
				$('#item1_1_6').css('bacground', 'none')
				$('#item1_1_7').css('bacground', 'none')
			...
			$('#item1_1_4').mouseenter(function () {
				...
				$('#item1_1_2').css('bacground', 'none')
				$('#item1_1_3').css('bacground', 'none')
				$('#item1_1_4').css('bacground', '#00B5EE')
				$('#item1_1_5').css('bacground', 'none')
				$('#item1_1_6').css('bacground', 'none')
				$('#item1_1_7').css('bacground', 'none')
			})
			$('#item1_1_5').mouseenter(function () {
				...
				$('#item1_1_3').css('bacground', 'none')
				$('#item1_1_4').css('bacground', 'none')
				$('#item1_1_5').css('bacground', '#00B5EE')
				$('#item1_1_6').css('bacground', 'none')
				$('#item1_1_7').css('bacground', 'none')
			})
			$('#item1_1_6').mouseenter(function () {
				...
				$('#item1_1_4').css('bacground', 'none')
				$('#item1_1_5').css('bacground', 'none')
				$('#item1_1_6').css('bacground', '#00B5EE')
				$('#item1_1_7').css('bacground', 'none')
			})
			$('#item1_1_7').mouseenter(function () {
				...
				$('#item1_1_5').css('bacground', 'none')
				$('#item1_1_6').css('bacground', 'none')
				$('#item1_1_7').css('bacground', '#00B5EE')
			})

			$('#item1_2_1').mouseenter(function () {
				$('#list1_2_3').removeClass('nav-list_active');
				$('#item1_2_1').css('bacground', '#00B5EE')
				$('#item1_2_2').css('bacground', 'none')
				$('#item1_2_3').css('bacground', 'none')
				$('#item1_2_4').css('bacground', 'none')
			})
			$('#item1_2_2').mouseenter(function () {
				$('#list1_2_3').removeClass('nav-list_active');
				$('#item1_2_2').css('bacground', '#00B5EE')
				$('#item1_2_1').css('bacground', 'none')
				$('#item1_2_3').css('bacground', 'none')
				$('#item1_2_4').css('bacground', 'none')
			})
			$('#item1_2_3').mouseenter(function () {
				$('#list1_2_3').addClass('nav-list_active');
				$('#item1_2_3').css('bacground', '#00B5EE')
				$('#item1_2_1').css('bacground', 'none')
				$('#item1_2_2').css('bacground', 'none')
				$('#item1_2_4').css('bacground', 'none')
			})
			$('#item1_2_4').mouseenter(function () {
				$('#list1_2_3').removeClass('nav-list_active');
				$('#item1_2_4').css('bacground', '#00B5EE')
				$('#item1_2_2').css('bacground', 'none')
				$('#item1_2_3').css('bacground', 'none')
				$('#item1_2_1').css('bacground', 'none')
			})			
